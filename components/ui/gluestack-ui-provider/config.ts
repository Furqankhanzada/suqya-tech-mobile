...
export const config = {
  light: vars({
    ...
    '--color-primary': '3 2 19',
    '--color-primary-foreground': '255 255 255',
    '--color-secondary': '236 238 242',
    '--color-secondary-foreground': '3 2 19',
    '--color-muted': '236 236 240',
    '--color-muted-foreground': '113 113 130',
    '--color-accent': '233 235 239',
    '--color-accent-foreground': '3 2 19',
    '--color-destructive': '212 24 61',
    '--color-destructive-foreground': '255 255 255',
    '--color-border': '#0000001a',
    '--color-input': 'transparent',
    '--color-input-background': '243 243 245',
    '--color-switch-background': '203 206 212',
    '--color-ring': '161 161 161',
    '--color-chart-1': '245 74 0',
    '--color-chart-2': '0 150 137',
    '--color-chart-3': '16 78 100',
    '--color-chart-4': '255 186 0',
    '--color-chart-5': '253 154 0',
    '--color-sidebar': '250 250 250',
    '--color-sidebar-foreground': '10 10 10',
    '--color-sidebar-primary': '3 2 19',
    ...
    '--color-priority-urgent': '212 24 61',
    '--color-priority-urgent-foreground': '255 255 255',

    '--color-priority-high': '254 226 226',
    '--color-priority-high-foreground': '193 0 7',

    '--color-priority-medium': '224 231 255',
    '--color-priority-medium-foreground': '55 42 172',

    '--color-priority-low': '254 243 198',
    '--color-priority-low-foreground': '151 60 0',
  }),
  dark: vars({
    ...
    '--color-destructive': '130 24 26',
    '--color-destructive-foreground': '251 44 54',
    '--color-border': '#262626',
    ...
    '--color-chart-3': '253 154 0',
    '--color-chart-4': '173 70 255',
    '--color-chart-5': '255 32 86',
    '--color-sidebar': '23 23 23',
    '--color-sidebar-foreground': '250 250 250',
    '--color-sidebar-primary': '20 71 230',
    '--color-sidebar-primary-foreground': '250 250 250',
    '--color-sidebar-accent': '38 38 38',
    '--color-sidebar-accent-foreground': '250 250 250',
    '--color-sidebar-border': '38 38 38',
    '--color-sidebar-ring': '82 82 82',

    '--color-priority-urgent': '130 24 26',
    '--color-priority-urgent-foreground': '255 255 255',

    '--color-priority-high': '69 10 10',
    '--color-priority-high-foreground': '255 162 162',

    '--color-priority-medium': '49 44 133',
    '--color-priority-medium-foreground': '224 231 255',

    '--color-priority-low': '123 51 6',
    '--color-priority-low-foreground': '254 243 198',
  }),
};
